...
fetch("https://openlibrary.org/subjects/fiction_action_&_adventure.json")
  .then((response) => response.json())
  .then((data) => {
    data.works.forEach((search) => {
      fetch("https://openlibrary.org" + search.key + ".json")
        ...
        .then((bookData) => {
          ...
          image.src =
            "https://covers.openlibrary.org/b/id/" + search.cover_id + ".jpg";
          image.alt = "none";
          ...
          buy_button.addEventListener("click", () => {
            const url =
              "https://www.betterworldbooks.com/product/detail/" +
              filteredIsbnList[0];
        ...
        .catch((error) => {
          ...
          const author = document.createElement("p");
          author.classList.add("search-author");
          author.innerHTML = "Author: " + search.authors.name;
